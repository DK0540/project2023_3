...
const Digitalcore = () => {
  ...
  return (
    <>
      <section
        class={DA.signupBody}
        style={{ height: "90vh", paddingTop: "20px", textAlign: "left" }}
      >
        <div className={DA.forms}>
          <div className={DA.formsdiv}>
            <label className={DA.fclabel} htmlFor="">
              Search
            </label>
            {/* <br /> */}
          ...
          <div className={DA.check}>
            <label className={DA.fclabel2} htmlFor="">
              In-Active
            </label>
            <div style={{ paddingRight: "18px" }}>
              <input className={DA.fccheck} type="checkbox" />
            </div>
          </div>
...
//       <section
//         class={DA.signupBody}
//         style={{ height: "100vh", paddingTop: "20px", textAlign: "center" }}
//       >
//         <div className={DA.forms}>
